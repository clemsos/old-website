...
$(document).ready(function() {
   ...
   // Useful variables
   var _c = 20,                 // The column width used throughout the document.
   ...
   $(".tag").each(function() {
      ...
      $('<span class="tip"> ('+_l+')</span>').appendTo(_this);
   });
   ...
   $(".tag").mouseenter(function() {
      ...
      if (_tags.is(".compact")) {
         _tags.data('expandtags',setTimeout(function() {_tags.removeClass("compact").freetile()},10));
      }
   }).mouseleave(function() {
      _this=$(this);
      // Transparent layer
